...
const schema = new mongoose.Schema({
  ...
  lessonFavorites: [{ type: mongoose.Schema.Types.ObjectId, ref: 'AiLesson' }],
  receivedPrompts: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Prompt' }],
  recentLessons: [{ type: mongoose.Schema.Types.ObjectId, ref: 'AiLesson' }],
  referredBy: { type: Number, default: null, index: true },
  referralValidated: { type: Boolean, default: false },
  validReferralCount: { type: Number, default: 0 },
  referralRewardIssued: { type: Boolean, default: false },
  referralDiscountUntil: { type: Date, default: null },
  appliedDiscountCode: { type: String, default: null },
  lastLessonDate: { type: String, default: null },
  lessonIndex: { type: Number, default: 0 },
  lessonsRead: { type: Number, default: 0 },
