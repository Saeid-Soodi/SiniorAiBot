...
const schema=new mongoose.Schema({
 ...
 isActive:{type:Boolean,default:true},isDeleted:{type:Boolean,default:false,index:true},deletedAt:{type:Date,default:null},deletedBy:{type:Number,default:null},totalClicks:{type:Number,default:0},uniqueClicks:{type:Number,default:0},joinSuccess:{type:Number,default:0},
