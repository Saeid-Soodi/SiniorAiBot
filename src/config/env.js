...
const env = {
  ...
  botUsername: clean(process.env.BOT_USERNAME),
  ...
  vipPriceToman: num(process.env.VIP_PRICE_TOMAN, 60000),
  vipDays: num(process.env.VIP_DAYS, 30),

  cardNumber: clean(process.env.CARD_NUMBER),
  cardHolder: process.env.CARD_HOLDER || 'سعید سودی',
  supportUsername: clean(process.env.SUPPORT_USERNAME || 'SAEEDSOODI'),
  instagramUsername: clean(process.env.INSTAGRAM_USERNAME || ''),

  referralRequired: num(process.env.REFERRAL_REQUIRED, 2),
