...
- ساخت آلبوم کانال با ۲ تا ۱۰ تصویر
- کپشن روی تصویر اول آلبوم
- دکمه‌های اینلاین برای آلبوم به‌صورت پیام لینک همراه (محدودیت Telegram برای Media Group)
- انتشار فوری یا زمان‌بندی پست
- زمان‌بندی با قالب `YYYY-MM-DD HH:mm` و offset قابل تنظیم
- مدیریت پست‌های زمان‌بندی‌شده
- انتشار فوری پست زمان‌بندی‌شده
- تغییر زمان انتشار
- لغو زمان‌بندی با حفظ تاریخچه
- Scheduler داخلی با بررسی خودکار پست‌های موعدرسیده

### تنظیم زمان

در `.env` یا Environment Variables هاست:

```env
SCHEDULE_UTC_OFFSET=+03:30
```

برای تهران مقدار پیش‌فرض `+03:30` مناسب است.

---


این نسخه دستور `/help` را با ارسال چندبخشی امن برای محدودیت طول پیام تلگرام اضافه می‌کند.
